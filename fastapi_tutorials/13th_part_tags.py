...
"""
Tag parameter is used with the path operations/APIRouters/endpoints in the decorator.
Tags help us in the documentation part.
"""
...
if __name__ == '__main__':
    uvicorn.run("13th_part_tags:app", reload=True)
